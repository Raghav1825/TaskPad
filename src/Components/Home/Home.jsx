...
function Home(){
    ...
    return(
        <div className="w-full  flex flex-col items-center p-1">
            <button className="flex flex-row items-center border-2 h-10 w-3xs justify-center md:h-11 md:w-xl lg:h-12 lg:w-2xl rounded-2xl bg-primary border-none hover:shadow-lg hover:shadow-black hover:scale-105 ease-in-out duration-300">
