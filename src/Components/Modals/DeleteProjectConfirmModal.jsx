...
function DeleteProjectConfirmModal({isOpen,onClose,projectId}){
    ...
    return(
        <>  
            ...
            <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-surface rounded-2xl shadow-xl p-6 flex flex-col gap-4 lg:w-xl md:w-lg">
                <p className="text-xl italic">Are you sure you want to delete this project ?</p>
                <div className="w-full flex gap-4">
                    <button className="bg-red-500 rounded-lg h-8 cursor-pointer flex-1" onClick={deleteProject}>Yes</button>
